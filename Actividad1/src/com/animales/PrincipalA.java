...
import com.animales.Animales;

public class PrincipalA {
	public static void main(String[] args) {
	    // Instanciar el objeto
	    Animales a1 = new Animales("Gato", "Siames", "Blanco", 2);
	    Animales a2 = new Animales("Gato", "Persa", "Amarillo", 5);
	    Animales a3 = new Animales("Gato", "Calicó", "Naranja, negro, blanco", 1);
	   	    
	    // Objeto auxiliar
	    Animales auAux = null;
	    
	    // Declaración de una lista para almacenar los objetos
	    List<Animales> lista = new ArrayList<Animales>();
...
/*
		...
		//editar elemento de la lista 
			    ...
			    //contar los elementos de la lista 
			    	System.out.println("existen " +  lista.size() + "gatitos en la lista");
			   ...
			   if(lista.isEmpty()) {
				   System.out.println("No existen gatos en la lista ");
			   } else {
				   System.out.println(lista);
			   }
			   */
	    ...
	    do {
	    	...
	    	System.out.println("4.- Buscar por atributo");
	    	...
	    	case 1: 
	    		...
	    		//instanciar
	    		auAux = new Animales(Especie, Raza, Color, Años);
	    		//guardar en la lista 
	    		lista.add(auAux);
	    	...
	    	case 3:
	    		...
	    		do {
	    			...
	    			System.out.println("2.-editar Raza");
	    			...
	    			switch(menuEditar) {
	    			case 1: 
	    				System.out.println("Escribe la nueva Especie");
	    				scan = new Scanner (System.in);
	    				Especie= scan.nextLine();
	    				auAux.setEspecie(Especie);
	    	...
	    	case 4: 
	    		...
	    		System.out.println("Indica el atributo para mostrar información");
	    		scan = new Scanner(System.in);
	    		String buscar = scan.nextLine();
	    		
	    		System.out.println("\nResultados de búsqueda:");
	    	    for (Animales animal : lista) {
	    	        if (animal.getEspecie().equalsIgnoreCase(buscar) ||
	    	            animal.getRaza().equalsIgnoreCase(buscar) ||
	    	            animal.getColor().toLowerCase().contains(buscar.toLowerCase()) ||
	    	            String.valueOf(animal.getAños()).equals(buscar)) {
	    	            
	    	            System.out.println("Encontrado: " + animal);
	    	        }
	    	    }
	    	    break;
	    		
	    	case 5:
	    		System.out.println("5.- Eliminar registro por atributo ");
	    		System.out.println("Indique el registro a eliminar");
	    		scan = new Scanner(System.in);
	    	    String eliminar = scan.nextLine();
	    	    
	    	    int validar = lista.size();
	    	    
	    	    lista.removeIf(animal -> 
	    	        animal.getEspecie().equalsIgnoreCase(eliminar) ||
	    	        animal.getRaza().equalsIgnoreCase(eliminar) ||
	    	        animal.getColor().toLowerCase().contains(eliminar.toLowerCase()) ||
	    	        String.valueOf(animal.getAños()).equals(eliminar)
	    	    );
	    	    
	    	    if (lista.size() == validar) {
	    	        System.out.println("ERROR: El elemento no existe, no se puede eliminar");
	    	    } else {
	    	        System.out.println("Eliminado(s) exitosamente");
	    	        System.out.println("\nLista actualizada:\n" + lista);
	    	    }
	    	    break;
	    	...
	    	case 6:
	    		System.out.println("6.- Contar ");
	    		System.out.println("Existen" + lista.size() + "Gatitos registrados");
	    		break;
